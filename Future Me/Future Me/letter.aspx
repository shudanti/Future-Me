<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="letter.aspx.cs" Inherits="Future_Me.letter" %>
                ...
                <div class="registrationform">
                    <div class="form-horizontal">
                        <fieldset runat="server" id="letterContain">
                            <legend>100 public letters from futureme.org <i class="fa fa-pencil pull-right"></i></legend>       
                        </fieldset>
                    </div>
                </div>
            </div>
